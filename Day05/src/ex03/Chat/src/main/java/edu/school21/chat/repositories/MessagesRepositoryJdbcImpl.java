...
//        String updateQuery = "UPDATE chat.message " +
//                "SET message '?', " +
//                "time = " + "'" + message.getLocalDateTime() + "' " +
//                "author = ?, " +
//                "room_id = ?, " +
//                "WHERE id = ?;";
        ...
        String updateQuery = "UPDATE chat.message " +
                ...
                "room_id = " + message.getChatroom().getId() + " " +
                "WHERE id = " + message.getId() + ";";

//        String updateQuery = "UPDATE chat.message " +
//                "SET room_id = " + message.getChatroom().getId() + ", " +
//                "author = " + message.getAuthor().getId() + ", " +
...
//                "WHERE id = " + message.getId() + ";";
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            throw new NotSavedSubEntityException("Not updated");
        }
